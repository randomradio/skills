...
[[ -x "$SKILL_DIR/scripts/check_for_updates.sh" ]] || fail "scripts/check_for_updates.sh missing or not executable"
...
bash -n "$SKILL_DIR/scripts/check_for_updates.sh" || fail "check_for_updates.sh has shell syntax errors"
